      ...
      <div className="flex flex-col md:flex-row w-screen h-[400vh] md:w-[400vw] md:h-screen">
        ...
        >
          ...
          <div className="max-w-xl">
            ...
            <div className='max-md:flex max-md:justify-center'>
              <button className="rounded-md border border-slate-300 shadow-xl w-50 px-6 py-3">
              MORE
            </button>
            </div>
          </div>
        ...
        >
          <div className="flex flex-col items-center gap-5 w-1/2 max-md:w-full justify-center">
            ...
            <button className="rounded-md border border-slate-300 shadow-xl w-50 px-6 py-3 max-md:mt-10">
              LEARN MORE
            </button>
          </div>
        </div>
        ...
        >
          ...
          <div className="w-full h-full flex justify-center items-center ">
            <div className="flex flex-col items-center gap-5 px-4">
              ...
              <p className="text-2xl text-center">Strategic Planning</p>
            </div>
          </div>
